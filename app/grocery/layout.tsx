...
export default async function GroceryLayout({
  ...
  try {
    ...
    // 3. ป้องกันไม่ให้ร้านประเภทอื่นหลงเข้ามาในระบบโชห่วย
  ...
  // ถ้าผ่านด่านทั้งหมด แสดงหน้าแดชบอร์ดโชห่วยได้
  return (
    <div className="grocery-system-wrapper min-h-screen bg-gray-50">
      {children}
    </div>
  );
}